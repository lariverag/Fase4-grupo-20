<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VerContenido.aspx.vb" Inherits="EJ6_PagWeb2023.Index" %>
...
<body>
    ...
    <div class="container">
        ...
        <div>
            <asp:DropDownList ID="TemasDropDownList" runat="server" AutoPostBack="False" onchange="CambiarContenido()">
                <asp:ListItem Text="Tema" Value="Tema" />
                <asp:ListItem Text="TensorFlow" Value="TensorFlow" />
                <asp:ListItem Text="Video" Value="Video" />
                <asp:ListItem Text="Sonido" Value="Sonido" />
                <asp:ListItem Text="Documento PDF" Value="PDF" />
            </asp:DropDownList>
            <br />

            
                <br /><a href="Index.aspx"><img src="Recursos/Home.png" width="30" height="30" alt="Inicio" title="Volver a la Pag Principal"  /></a>
           <ul><li>Presentado por: Alvaro Javier Martinez Fierro</li></ul>
            
            
            <asp:Panel ID="ContenidoPanel" runat="server">
                <div id="TensorFlow" style="display: none;">
    ...
    <ul>
        ...
        <li>Análisis de datos y predicción: en una variedad de campos, desde finanzas hasta biología.</li>
                ...
                <div id="Video" style="display: none; text-align: center">
                    <h2>Multimedia</h2>
                    <video controls="controls" id="Videos" runat="server" width="500" height="300">
        ...
        <li><a href="https://www.youtube.com/watch?v=CahXWhovhKA&ab_channel=divcode">Tensorflow en Python Visual Studio Code</a></li>
                ...
                <div id="Sonido" style="display: none;">
                    <h2>Multimedia</h2>
                    <audio controls="controls" id="SonidoTema" runat="server">
...
<script type="text/javascript">
    function CambiarContenido() {
        var temaSeleccionado = document.getElementById("<%= TemasDropDownList.ClientID %>").value;
            var contenidoPanel = document.getElementById("<%= ContenidoPanel.ClientID %>");

        // Ocultar todos los elementos dentro de ContenidoPanel
        for (var i = 0; i < contenidoPanel.childNodes.length; i++) {
            if (contenidoPanel.childNodes[i].style) {
                contenidoPanel.childNodes[i].style.display = "none";
            }
        }
